...
import bestroomie.gui.BRRemoveUserFromGroupGUI;
import bestroomie.util.BRConst;
import bestroomie.util.BRUtil;
import bestroomie.controller.BRMainGuiController;

public class BRRemoveUserFromGroupController extends BRAbstractController {
	
	private BRUser model;
	private BRRemoveUserFromGroupGUI view;
	private BRRemoveUserFromGroupController mainController;
	private BRMainGuiController assistantController;
	
	public BRRemoveUserFromGroupController(BRUser m, BRRemoveUserFromGroupGUI v, BRMainGuiController c, BRRemoveUserFromGroupController d) {
		this.model = m;
		this.view = v;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Remove User")) {
			...
			//if the user doesn't exist in the database
				...
				//Add the user
				writeDatabase.removeUserFromGroup(view.getuEmail(), grpId);
