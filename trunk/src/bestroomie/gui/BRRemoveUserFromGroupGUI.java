...
public class BRRemoveUserFromGroupGUI extends BRAbstractView {
	
	private final JLabel jlblEmail = new JLabel("Email of user to remove from group:");

	private final JTextField jtfuEmail = new JTextField(20);

	private final JButton jbtRemoveUser = new JButton("Remove User");
	...
	public BRRemoveUserFromGroupGUI () {
		this.setupUI();
	}
	...
	public void registerListener(BRAbstractController a) {
		...
		jbtRemoveUser.addActionListener(a);
